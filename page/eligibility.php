...
echo GenesisThemeShortCodes::readingBox(
    "Welcome to the 2 Day Wythenshawe Programme",
    "<p>The 2 Day Wythenshawe Programme is a diet and exercise programme designed to support people with a BMI greater than 25 to lose weight.</p>
    ...
    <div class="question-outer-container">
         <div class="inner-question-container">
            ...
            <div class="question-container">
                ...
                <div class="col">
                    <label for="consent"><?php _e('I give my consent that 2 Day Wythenshawe Programme may use the information I have entered for research purposes. <br /><em>We will never share your data with any third parties</em>')?></label>
                    </div>
                </div>
            </div>
        </div>
