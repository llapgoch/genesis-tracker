...
<?php 
echo GenesisThemeShortCodes::readingBox('Enter Your Physiotec Login Details', 'Please enter your login details to view the Physiotec prescription exercise videos. <em>Please note: these are different to your Procas Lifestyle login details</em>');
?>
