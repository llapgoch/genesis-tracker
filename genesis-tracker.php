...
if(!is_admin()){
    ...
    add_filter( 'login_message', function($message){
        if(GenesisTracker::isOnDoctorEligibilityRegistrationPage()){
            return Gene∂sisThemeShortCodes::readingBox(
